            ...
            <div class="card">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-5">
                        ...
                        <label for="id_convocatoria" class="form-label">Modalidad - Sede</label>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                                                        ...
                                                        <table class="table mb-0" id="dataLotePrintCertificados">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{$estudiantes_certList["codigo_siadi_certificado"]}}</td>
                                                                </tr>
                                                                @endforeach
                                                            </tbody>
                                                        </table>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="check_modificar_formatos" wire:model="check_modificar_formatos" value="{{$check_modificar_formatos}}">
                                                <label class="form-check-label ms-1" for="check_modificar_formatos">Modificar Formatos</label>
                                            </div>
                                            @error('formato_lote')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="check_modificar_fecha" wire:model="check_modificar_fecha" value="{{$check_modificar_fecha}}">
                                                <label class="form-check-label ms-1" for="check_modificar_fecha">Modificar Fecha</label>
                                            </div>
                                            @error('fecha_lote')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                            ...
                            <div class="modal-footer d-flex justify-content-center">
                                ...
                                @if(count($certificado_lote)>0 && $this->operation=='imprimir_pdf_lote')
                                    @canany(['certificado.lotes.edit', 'certificado.lotes.print'])
