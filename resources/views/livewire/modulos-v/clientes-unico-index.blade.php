    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">ADMINISTRACIÓN DE CLIENTE : {{ $clientes->nombre }}
                    {{ $clientes->apellidos }} </h4>
                            ...
                            <div class="card radius-10 border-start border-1 border-5 border-info "
                                ...
                                <div class="card-header">
                                    ...
                                    <span class="d-block text-center text-secondary">
                                        <b>{{ $clientes->nombre }} {{ $clientes->apellidos }} </b>
                                    </span>
                                </div>
                                <div class="card-body">
                                        ...
                                        <ul class="list-group col-md-7 border-2">
                                            <li
                                                ...
                                                <div>
                                                    ...
                                                    <span>{{ $clientes->domicilio }}</span><br>
                                            ...
                                            <li
                                                ...
                                                <div>
                                                    ...
                                                    <span>{{ $clientes->ci }}</span>
                                                </div>
                                                <div>
                                                    <b>EXPEDIDO:</b> <br>
                                                    <span>{{ $clientes->expedido }}</span>
                                                </div>
                                                ...
                                                <div>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <div class="dropdown-menu"
                                                            ...
                                                            @foreach ($clientes->cliente_mascotas as $mascota)
                                                    ...
                                                    <button class=" btn btn-outline-success"
                                                        wire:click="SacarTotalDia({{ $clientes->id }})">TOTAL A PAGAR
                                                        DEL DIA</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    @php
                                                        ...
                                                        foreach ($clientes->cliente_mascotas as $value) {
                                                    ...
                                                    @if ($tienedatosactivos == 1)
                                                        <button class="btn btn-sm btn-success"
                                                            wire:click="VerMascotas({{ $clientes->id }})">Ver
                                                            Mascotas</button>
                                                    @else
                                                        <button class="btn btn-sm btn-warning"
                                                            wire:click="crearmascota({{ $clientes->id }})">
                                                            Crear Mascota
                                                        </button>
                                                    @endif
                                                ...
                                                <div class="col-md-6 border-start border-0 border-2">
                                                    ...
                                                    <button class="btn btn-danger"
                                                        wire:click.prevent="$emit('borrarcliente', {{ $clientes->id }})"><i
                                                            class="bx bxs-trash"></i></button>
                                                    <button class="btn btn-warning"
                                                        wire:click="editarcliente({{ $clientes->id }})"><i
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input type="date" class="form-control"
                                                    ...
                                                    placeholder="Ingrese la proxima fecha de atención">
                                                @error('ProximaFecha')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    placeholder="Ingrese la peso de la mascota">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    wire:model="ProductoDosis"placeholder="Ingrese la dosis de la mascota">
                                                @error('ProductoDosis')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <label class="form-label">Precio</label>
                                                <input type="number" class="form-control"
                                                    wire:model="PrecioDesparacitacion"
                                                    placeholder="Precio de la Desparacitación">
                                ...
                                @if ($AtencionDiaHistorial)
                                    @foreach ($AtencionDiaHistorial as $atencion)
                                        <tr>
                                            ...
                                            <td>{{ $atencion->hitorialtipohistorial->nombre }}</td>
                                ...
                                @if ($AtencionFarmacia)
                                    @foreach ($AtencionFarmacia as $farma)
                                        <tr>
                                            ...
                                            <td>{{ $farma->mascota_ventas->nombre }}</td>

                                            <td> se realizo la venta de : @foreach ($farma->ventas_realizadas as $producto)
                                                    {{ $producto->produc_ventas->nombre }}
                                                @endforeach
                                            </td>
                                            <td>{{ $farma->total }} Bs.</td>
                                            <td> S/N</td>
                                ...
                                @php
                                    ...
                                    if ($AtencionFarmacia) {
                                        foreach ($AtencionFarmacia as $value7) {
                                            $totalApagar = $totalApagar + $value7->total;
                                        }
                                    }
                                    if ($AtencionInteracion) {
                                        ...
                                        <h2 class="accordion-header" id="heading-{{ $internacion->id }}">
                                            <button class="accordion-button collapsed text-white rounded-3"
                                                ...
                                                <span class="tex-info rounded p-2" style="color: #27ef30;">
                                                    INTERNACION EN FECHA - {{ $internacion->created_at }}
                                                </span>
                                            </button>
                                                    ...
                                                    <div class="col-md-6">
                                                        <button class="btn btn-danger"
                                                            wire:click.prevent="$emit('borrar_internacion', {{ $internacion->id }})"><i
                                                                ...
                                                                INTERNACION</i></button>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="" class="form-label"> Ingresar costo
                                                            total de internacion</label>
                                                        <div class="col-md-6">
