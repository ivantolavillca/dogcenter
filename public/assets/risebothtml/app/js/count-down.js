...
(function () {
    ...
    CountDown.prototype.updateCountDown = function (bool) {
        ...
        /* if (bool && days == 0 && this.visibleLabels.indexOf('d') < 0) days= "00";
        if (bool && days == 0 && hours == 0 && this.visibleLabels.indexOf('h') < 0) hours = "00"; 
        if (bool && days == 0 && hours == 0 && mins == 0 && this.visibleLabels.indexOf('m') < 0) mins = "00"; */
