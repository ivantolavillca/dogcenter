<ul id="menu-primary-menu" class="menu" role="tablist">
    ...
    <li class="menu-item @if(request()->route()->getName()=='verificar.old.index') current-menu-item @endif">
        <a href="{{ route('verificar.old.index') }}">VERIFICAR CERTIFICADO</a>
    </li>
    <li class="menu-item ">
        <a href="https://www.upea.bo/" target="_blank">UPEA</a>
    </li>
    <li class="menu-item menu-item-has-children @if(request()->route()->getName()=='inicio.index') current-menu-item @endif">
        <a href="{{ route('inicio.index') }}" id="tab1-tab" data-bs-toggle="tab" role="tab" aria-controls="tab1" aria-selected="true">nuevo</a>
        <ul class="sub-menu">
            <li class="menu-item "><a href="#">SOBRE NOSOTROS</a></li>
            <li class="menu-item"><a href="#">CONTACTO</a></li>
        </ul>
