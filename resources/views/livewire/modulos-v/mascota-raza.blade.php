    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">ADMINISTRACIÓ DE RAZAS</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home.index') }}">Inicio</a></li>
                        <li class="breadcrumb-item active">RAZAS DE MASCOTAS</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <button class="btn btn-info col-md-12" data-bs-toggle="modal" data-bs-target="#modalcrearraza">
                            <i class="bx bxs-plus-circle"></i> AGREGAR RAZA
                        </button>
                    </div>
                ...
                <div class="col-12 mt-3">
                    <label for="gestiones" class="form-label">Buscar Raza: </label>
                                ...
                                <div class="d-flex align-items-center row g-3">
                                    <ul class="list-group col-md-7 border-2">
                                        <li class="list-group-item d-flex justify-content-between align-items-center text-secondary">
                                            <div>
                                                <i class="fs-6 bx bxs-home"></i> <b> NOMBRE DE LA RAZA</b> <br>
