<div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">paraleloS</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-outline-primary waves-effect waves-light col-md-6 "
                                data-bs-toggle="modal" data-bs-target="#agregarparalelo"> <i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button"
                                                    ...
                                                    wire:click="editar_paralelo({{ $paralelo->id_paralelo }})">
                                                ...
                                                <button type="button"
                                                    ...
                                                    wire:click.prevent="$emit('deleteconvoca', {{ $paralelo->id_paralelo }})">
            ...
            <div wire:ignore.self data-bs-backdrop="static" id="editarparalelo" class="modal fade" tabindex="-1"
                role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title mt-0" id="myModalLabel"> EDITAR paralelo
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-6">
                                    ...
                                    <input type="text" class="form-control" wire:model="paralelo2">
                                    @error('paralelo2')
                        ...
                        <div class="modal-footer d-flex justify-content-center">
                            ...
                            <button class="btn btn-primary waves-effect waves-light"
                                wire:click="guardarEditadoparalelo">GUARDAR DATOS</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
            ...
            <div wire:ignore.self id="agregarparalelo" class="modal fade" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-6">
                                    <label class="form-label">paralelo:</label>
                                    <input type="text" class="form-control" wire:model="paralelo">
                                    @error('paralelo')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="modal-footer d-flex justify-content-center">
                            ...
                            <button wire:click="guardar_paralelo"
