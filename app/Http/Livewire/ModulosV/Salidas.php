...
class Salidas extends Stock
{
    ...
    {
       $this-> Idventa= $id_ven;
       $this->data = VentasProductos::where('id_venta', $id_ven)->get();
       $this->totalDinero= Ventas::find($id_ven)->total;
       $this->emit("abrirmodalventas");

    }
    public function LimpiarmodalTabla()
    {
       $this->emit("cerrarmodalventas");
    }
    ...
    {
        $Ventas = Ventas::where('estado', '=', 'activo')
        ...
        return view('livewire.modulos-v.salidas', compact('productos', 'clientes','Ventas'));
    }
