<div>
        ...
        <div class="card">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">LISTA DE COMPRAS DE PRODUCTOS</h4>
                    ...
                    <tbody>
                        ...
                        <button class="btn btn-info col-md-12" wire:click="abrirModalCompra({{$ven->id}})">
                            ...
                            <td>
                                ...
                                <a href="{{ route('imprimirVentas', ['idm' => $ven->id, 'es' => 1]) }}" class="btn btn-primary" target="_blank">
    ...
    @include('livewire.modal-compras.modalcompra')
</div>

@push('molqui-js')
<script>
    document.addEventListener('livewire:load', function() {
        Livewire.on('cerrarmodalcompras', function() {
            $('#modalcompra').modal('hide');
        });
        Livewire.on('abrirmodalcompras', function() {
