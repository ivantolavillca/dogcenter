...
class ClientesUnicoIndex extends Stock
{
    ...
    protected $listeners = [
        'eliminarcliente','resultadoReconocimiento', 'imagenCapturadaMascota', 'EliminarMascota', 'resultadoReconocimientoAnamensis', 'resultadoReconocimientoMotivoConsulta', 'EliminarVacuna', 'EliminarDesparacitaciones', 'imagenCapturada'
    ];
    public $a = false;
    public $b = false;
    public $c = false;
    ...
    private function rulesguardarinternacionmedicamentos()
    {
        return [
    ...
    private function rulesgcostointernacion()
    {
        return [

            'CostoInternacion' => 'required|numeric|between:0,999999.99',
    ...
    private function rulesvalidarcomentarioInternacion()
    {
    ...
    public $MascotaVacunas, $EdadEnVacunas, $PesoEnDesparacitacion, $ProductoDosis,$VacunaAplicada, $ProximaFecha, $Veterinario, $EdadEnDesparacitacion, $Producto, $ProximaFechaDesparacitacion, $VeterinarioDesparacitacion;
  ...
  //--------------------
    ...
    public function GuardarComentarioInternacion($internacionid)
    {
        ...
        $this->reset('DescripcionInternacion');
    }
    ...
    public function render()
    {
       ...
       if ($this->ClienteParaDia) {
        ...
        return view('livewire.modulos-v.clientes-unico-index', compact(
            ...
            'registro_completoprodu','AtencionDiaHistorial','AtencionInteracion'
